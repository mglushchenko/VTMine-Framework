...
// 1) logV, logD (только первые буквы от типа сообщения)

// 2) завести модуль unitilies, в который пойдут разные утилиты, типа псевдонимов
//    типов (UInt, UByte...) в пространстве имен vtmine
